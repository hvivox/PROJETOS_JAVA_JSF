...
@Entity
@Table(name = "PromocaoIdoso", catalog = "formulario")
@AttributeOverride(name = "id", column = @Column(name = "idDPromocaoIdoso"))
public class PromocaoIdoso extends ValueObject{
	...
	@Column(name = "empresa", nullable = true, length = 250)
