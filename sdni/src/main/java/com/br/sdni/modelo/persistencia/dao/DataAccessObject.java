...
import com.br.sdni.modelo.negocios.excecao.ConsultaInvalidaException;
import com.br.sdni.modelo.negocios.excecao.EntityIdNuloException;
import com.br.sdni.modelo.negocios.excecao.ErroQueryException;
import com.br.sdni.modelo.negocios.excecao.MultiplosResultadosParaRecuperarObjetoException;
...
import com.br.sdni.modelo.persistencia.entidade.mapeadas.ValueObject;
...
public abstract class DataAccessObject<T extends ValueObject> implements
	...
	public List<T> consultarTodos(){
		return manager.createQuery("from "+getPersistentClass().getSimpleName(), getPersistentClass())
				.getResultList();
	}
