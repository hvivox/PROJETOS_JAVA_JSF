package com.br.sdni.util.manipularDados;
...
import com.br.sdni.util.cdi.qualifier.DataAno;
import com.br.sdni.util.cdi.qualifier.DataMesPorExtenso;
import com.br.sdni.util.cdi.qualifier.DataTexto;
...
public class ConversorData {
	...
	public static Calendar converteStringAnoEmCalendar(String anoParametro){
		int ano = Integer.parseInt(anoParametro);
		Calendar dataInputada = Calendar.getInstance();
	...
	public static void main(String[] args) {
		...
		calendar = converteStringAnoEmCalendar("2017");
		System.out.println("Ano Calendar: "+ calendar);
	}
